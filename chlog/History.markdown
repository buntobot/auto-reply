...
### Minor Enhancements
  ...
  * General improvements for WEBrick via bunto serve such as SSL & custom headers (#4224, #4228)
  ...
  * Add a Bunto doctor warning for URLs that only differ by case (#3171)
...
### Bug Fixes
  ...
  * Make sure bunto/drops/drop is loaded first. (#4292)
...
### Development Fixes
  ...
  * `bunto-docs` should be easily release-able (#4152)
  * Allow use of Cucumber 2.1 or greater (#4181)
  * Modernize Kramdown for Markdown converter. (#4109)
  * Change TestDoctorCommand to BuntoUnitTest... (#4263)
...
### Site Enhancements
  ...
  * Add `bunto-deploy` to list of third-party plugins (#4179)
  ...
  * Update FormKeep link to be something more specific to Bunto (#4243)
  ...
  * Add bunto-paginate-category to list of third-party plugins (#4273)
  * Add `bunto-responsive_image` to list of third-party plugins (#4286)
  * Add `bunto-commonmark` to list of third-party plugins (#4299)
...
### Bug Fixes
  ...
  * Don't generate `.bunto-metadata` in non-incremental build (#4079)
...
### Site Enhancements
  ...
  * Adds a note about installing the bunto-gist gem to make gist tag work (#4101)
  * Align hooks documentation with implementation (#4104)
  * Add Bunto Flickr Plugin to the list of third party plugins (#4111)
  * Remove link to now-deleted blog post (#4125)
  * Update the liquid syntax in the pagination docs (#4130)
  * Add bunto-language-plugin to plugins.md (#4134)
...
### Major Enhancements
  ...
  * Add a Code of Conduct for the Bunto project (#3925)
...
### Minor Enhancements
  ...
  * Separate `bunto docs` and optimize external gem handling (#3241)
  ...
  * Split off Textile support into bunto-textile-converter (#3319)
  ...
  * Add `pkill -f bunto` to ways to kill. (#3397)
  ...
  * Removed the word 'Bunto' a few times from the comments (#3617)
  * `bin/bunto`: with no args, exit with exit code 1 (#3619)
  * Incremental build if destination file missing (#3614)
  * Static files `mtime` liquid should return a `Time` obj (#3596)
  * Use `Bunto::Post`s for both LSI indexing and lookup. (#3629)
  ...
  * Perf: `Bunto::Cleaner#existing_files`: Call `keep_file_regex` and
    `keep_dirs` only once, not once per iteration (#3696)
  * Omit bunto/bunto-help from list of resources. (#3698)
  * Add basic `bunto doctor` test to detect fsnotify (OSX) anomalies. (#3704)
  * Added talk.buntorb.com to "Have questions?" (#3694)
...
### Bug Fixes
  ...
  * Perform bunto-paginate deprecation warning correctly. (#3580)
  ...
  * Ignore `.bunto-metadata` in site template (#3496)
  ...
  * Add WOFF2 font MIME type to Bunto server MIME types (#3647)
  ...
  * Open `.bunto-metadata` in binary mode to read binary Marshal data (#3713)
  ...
  * Read build options for `bunto clean` command (#3828)
...
### Development Fixes
  ...
  * Fix comment typo in `lib/bunto/frontmatter_defaults.rb` (#3322)
  ...
  * Added tests for `Bunto:StaticFile` (#3633)
  ...
  * Update JRuby testing to 9K ([3ab386f](https://github.com/bunto/bunto/commit/3ab386f1b096be25a24fe038fc70fd0fb08d545d))
...
### Site Enhancements
  ...
  * Add blog post announcing Bunto Help (#3523)
  * Add Bunto Talk to Help page on site (#3518)
  * Change Ajax pagination resource link to use HTTPS (#3570)
  * Fixing the default host on docs (#3229)
  * Add `bunto-thumbnail-filter` to list of third-party plugins (#2790)
  * Add link to 'Adding Ajax pagination to Bunto' to Resources page (#3186)
  ...
  * Add `bunto-minifier` to list of third-party plugins (#3333)
  * Add blog post about the Bunto meet-up (#3332)
  ...
  * Release buntorb.com as a locally-compiled site. (#3426)
  * Add a buntorb.com/help page which elucidates places from which to get help (#3428)
  ...
  * Add bunto-auto-image generator to the list of third-party plugins (#3489)
  ...
  * Add information about the `.bunto-metadata` file (#3597)
  * Document addition of variable parameters to an include (#3581)
  * Add `bunto-files` to the list of third-party plugins. (#3586)
  ...
  * Upgrade pieces of the Ugrading guide for Bunto 3 (#3607)
  ...
  * Update the link in the welcome post to point to Bunto Talk (#3745)
  * Update link for navbars with data attributes tutorial (#3728)
  * Add `bunto-asciinema` to list of third-party plugins (#3750)
  ...
  * Add Bunto Portfolio Generator to list of plugins (#3883)
  ...
  * Add alternative bunto gem installation instructions (#4018)
  ...
  * Add bunto-smartify to the list of third-party plugins (#3572)
...
### Site Enhancements
  ...
  * Add `@alfredxing` to the `@bunto/core` team. :tada: (#3218)
  ...
  * Add bunto-500px-embed to list of third-party plugins (#3163)
  * Simplified platform detection in Gemfile example for Windows (#3177)
  * Add the `bunto-jalali` plugin added to the list of third-party plugins. (#3198)
  * Add Table of Contents to Troubleshooting page (#3196)
  * Add `inline_highlight` plugin to list of third-party plugins (#3212)
  * Add `bunto-mermaid` plugin to list of third-party plugins (#3222)
...
### Bug Fixes
  ...
  * Fix bundle require for `:bunto_plugins` (#3119)
...
### Site Enhancements
  ...
  * Slightly compress bunto-sticker.jpg. (#3133)
...
### Minor Enhancements
  ...
  * Require gems in `:bunto_plugins` Gemfile group unless `BUNTO_NO_BUNDLER_REQUIRE` is specified in the environment. (#2865)
  * Centralize path sanitation in the `Site` object (#2882)
  * Allow placeholders in permalinks (#3031)
  * Allow users to specify the log level via `BUNTO_LOG_LEVEL`. (#3067)
...
### Bug Fixes
  ...
  * In the case that a Gemfile does not exist, ensure Bunto doesn't fail on requiring the Gemfile group (#3066)

### Development Fixes

  * Fix a typo in the doc block for `Bunto::URL.escape_path` (#3052)
  * Add integration test for `bunto new --blank` in TestUnit (#2913)
  * Add unit test for `bunto new --force` logic (#2929)
...
### Site Enhancements
  ...
  * Add FormKeep to resources as Bunto form backend (#3010)
  ...
  * Add 'Bunto Twitter Plugin' to list of third-party plugins (#2979)
...
### Bug Fixes
  ...
  * Use `Bunto.sanitized_path` when adding static files to Collections (#2849)
...
### Site Enhancements
  ...
  * Adds info about installing bunto in current dir (#2839)
  * Remove deprecated `bunto-projectlist` plugin from list of third-party
    plugins (#2742)
  * Remove tag plugins that are built in to Bunto (#2751)
...
### Bug Fixes
  ...
  * Refactor based on bunto-watch clean-up. (#2716)
...
### Site Enhancements
  ...
  * Add link to `bunto-slim` in list of third-party plugins (#2689)
...
### Bug Fixes
  ...
  * Remove unnecessary `Bunto::Tags::IncludeTag#blank?` method (#2625)
...
### Minor Enhancements
  ...
  * Add `Bunto.env` and `bunto.environment` (the Liquid var) (#2417)
  ...
  * Extract Pagination Generator into gem: `bunto-paginate` (#2455)
...
### Development Fixes
  ...
  * Fix a bit of missing TomDoc to `Bunto::Commands::Build#build` (#2554)
...
### Site Enhancements
  ...
  * Add `bunto_github_sample` plugin to list of third-party plugins (#2463)
  * Clarify documentation around front matter defaults and add details
    about defaults for collections. (#2439)
  * Add Bunto Project Version Tag to list of third-party plugins (#2468)
  * Use `https` for GitHub links across whole site (#2470)
  * Add StickerMule + Bunto post (#2476)
  * Add Bunto Asset Pipeline Reborn to list of third-party plugins (#2479)
  * Add link to bunto-compress-html to list of third-party plugins (#2514)
  ...
  * Documentation for Continuous Integration for your Bunto Site (#2432)
...
### Bug Fixes
  ...
  * `Bunto::Filters#time` now accepts UNIX timestamps in string or number form (#2339)
...
### Major Enhancements
  ...
  * Move to bunto/bunto from mojombo/bunto (#1817)
  ...
  * Complete redesign of the template site generated by `bunto new` (#2050)
...
### Minor Enhancements
  * Move the EntryFilter class into the Bunto module to avoid polluting the
  ...
  * Bring MIME Types file for `bunto serve` to complete parity with GH Pages
    servers (#1993)
  ...
  * Add `Bunto::LiquidExtensions` with `.lookup_variable` method for easy
...
### Bug Fixes
  ...
  * Add `#path` to required methods in `Bunto::Convertible` (#1866)
  * Default Maruku fenced code blocks to ON for 2.0.0-dev (#1831)
  * Change short opts for host and port for `bunto docs` to be consistent with
  ...
  * Remove obsolete `normalize_options` method call from `bin/bunto` (#2121).
  ...
  * Only use Bunto.logger for output (#2307)
...
### Development Fixes
  ...
  * Test Bunto under Ruby 2.1.0 (#1900)
  ...
  * Streamline Cucumber execution of `bunto` subcommands (#2258)
...
### Site Enhancements
  ...
  * Add bunto-compass to the plugin list (#1923)
  ...
  * Add `bunto-humanize` plugin to plugin list (#1998)
  * Add `bunto-font-awesome` plugin to plugin list (#1999)
  * Add `sublime-bunto` to list of Editor plugins (#2001)
  * Add `vim-bunto` to the list of Editor plugins (#2005)
  ...
  * Update link to rack-bunto on "Deployment Methods" page (#2047)
  ...
  * Add Bunto Pages Directory plugin to list of plugins (#2096)
  * Update Configuration docs page with new markdown extension (#2102)
  * Add `bunto-image-set` to the list of third-party plugins (#2105)
  * Losslessly compress images (#2128)
  * Update normalize.css to 3.0.0 (#2126)
  * Update modernizr to v2.7.1 (#2129)
  * Add `bunto-ordinal` to list of third-party plugins (#2150)
  * Add `bunto_figure` to list of third-party plugins (#2158)
  ...
  * Add `bunto-page-collections` to list of third-party plugins (#2215)
  * Add a cross-reference about `post_url` (#2243)
  * Add `bunto-live-tiles` to list of third-party plugins (#2250)
  * Fixed broken link to GitHub training material site source (#2257)
  * Update link to help repo, now called `bunto-help` (#2277)
  * Fix capitalization of 'Bunto' on Deployment Methods page (#2291)
...
### Site Enhancements
  * Fixed case of a word in the Bunto v1.3.0 release post (#1762)
...
### Site Enhancements
  ...
  * Add `bunto-monthly-archive-plugin` and `bunto-category-archive-plugin` to
    list of third-party plugins (#1693)
  * Add `bunto-asset-path-plugin` to list of third-party plugins (#1670)
  * Add `emoji-for-bunto` to list of third-part plugins (#1708)
  ...
  * Point "Blog migrations" page to http://import.buntorb.com (#1732)
...
### Minor Enhancements
  ...
  * Provide better error handling for Bunto's custom Liquid tags
    (#1514)
  ...
  * Point people to the migration docs when the `bunto-import` gem is
    missing (#1662)
...
### Site Enhancements
  * Fix params for `BuntoImport::WordPress.process` arguments (#1554)
  * Add `bunto-suggested-tweet` to list of third-party plugins (#1555)
  ...
  * Improve the instructions for mimicking GitHub Flavored Markdown
    (#1614)
  * Add `bunto-import` warning note of missing dependencies (#1626)
...
### Minor Enhancements
  ...
  * Disable reverse lookup when running `bunto serve` (#1363)
...
### Major Enhancements
  ...
  * Add checking for URL conflicts when running `bunto doctor` (#1389)
...
### Minor Enhancements
  ...
  * Add the ability to detach the server ran by `bunto serve` from it's
    controlling terminal (#1443)
  * Improve permalink generation for URLs with special characters (#944)
  * Expose the current Bunto version to posts and pages via a new
    `bunto.version` variable (#1481)
...
### Development Fixes
  * Remove redundant argument to
    Bunto::Commands::New#scaffold_post_content (#1356)
  ...
  * Refactor `Site#cleanup` into `Bunto::Site::Cleaner` class (#1429)
  * Several other small minor refactorings (#1341)
  * Ignore `_site` in buntorb.com deploy (#1480)
  * Add Gem version and dependency badge to README (#1497)

### Site Enhancements
  * Add info about new releases (#1353)
  * Update plugin list with bunto-rss plugin (#1354)
  * Update the site list page with Ruby's official site (#1358)
  * Add `bunto-ditaa` to list of third-party plugins (#1370)
  ...
  * Update the docs for Redcarpet in Bunto (#1418)
  ...
  * Use `site.repository` for Bunto's GitHub URL (#1463)
  * Add `bunto-pageless-redirects` to list of third-party plugins (#1486)
  * Clarify that `date_to_xmlschema` returns an ISO 8601 string (#1488)
  * Add `bunto-good-include` to list of third-party plugins (#1491)
  * XML escape the blog post title in our feed (#1501)
  * Add `bunto-toc-generator` to list of third-party plugins (#1506)
...
### Minor Enhancements
  * Remove superfluous `table` selector from main.css in `bunto new` template (#1328)
...
### Site Enhancements
  * Add Bunto Image Tag to the plugins list (#1306)
  ...
  * Improve the layout of the plugin listing by organizing it into
    categories (#1310)
  * Add generator-buntorb and grunt-bunto to plugins page (#1330)
  ...
  * Change filename in `include` example to an HTML file so as not to indicate that Bunto
    will automatically convert them. (#1303)
  * Add an RSS feed for commits to Bunto (#1343)

## 1.1.0 / 2013-07-14

### Major Enhancements
  * Add `docs` subcommand to read Bunto's docs when offline. (#1046)
...
### Minor Enhancements
  * Search the hierarchy of pagination path up to site root to determine template page for
    pagination. (#1198)
  * Add the ability to generate a new Bunto site without a template (#1171)
  * Use redcarpet as the default markdown engine in newly generated
    sites (#1245, #1247)
  * Add `redcarpet` as a runtime dependency so `bunto build` works out-of-the-box for new
    sites. (#1247)
...
### Site Enhancements
  ...
  * Remove plugins from the plugin list that have equivalents in Bunto
    proper (#1223)
  * Add bunto-assets to the plugin list (#1225)
  * Add bunto-pandoc-mulitple-formats to the plugin list (#1229)
  ...
  * Specify that RedCarpet is the default for new Bunto sites on Quickstart page (#1247)
  ...
  * Add `bunto-timeago` to list of third-party plugins. (#1260)
  * Add `bunto-swfobject` to list of third-party plugins. (#1263)
  * Add `bunto-picture-tag` to list of third-party plugins. (#1280)
...
### Minor Enhancements
  ...
  * Add a `--force` option to `bunto new` (#1115)
  * Convert IDs in the site template to classes (#1170)

### Bug Fixes
  * Fix typo in Stevenson constant "ERROR". (#1166)
  * Rename Bunto::Logger to Bunto::Stevenson to fix inheritance issue (#1106)
  ...
  * Make the `exclude` and `include` options backwards compatible with
    versions of Bunto prior to 1.0 (#1114)
...
### Site Enhancements
  ...
  * Add link to bunto-minibundle in the doc's plugins list (#1035)
  * Quick patch for importers documentation
  * Fix prefix for WordpressDotCom importer in docs (#1107)
  * Add bunto-contentblocks plugin to docs (#1068)
  ...
  * Add the Bunto Gallery Plugin to the plugin list (#1143)

### Development Fixes
  * Use Bunto.logger instead of Bunto::Stevenson to log things (#1149)
...
### Major Enhancements
  * Add `bunto doctor` command to check site for any known compatibility problems (#1081)
...
### Development Fixes
  ...
  * Update links on README to point to new buntorb.com (#1018)

## 1.0.0 / 2013-05-06

### Major Enhancements
  * Add `bunto new` subcommand: generate a Bunto scaffold (#764)
  * Refactored Bunto commands into subcommands: build, serve, and migrate. (#690)
  * Removed importers/migrators from main project, migrated to bunto-import sub-gem (#793)
...
### Minor Enhancements
  ...
  * Freak out if the destination of `bunto new` exists and is non-empty (#981)
  ...
  * Load in GitHub Pages MIME Types on `bunto serve` (#847, #871)
  ...
  * New format of Bunto output (#795)
  ...
  * Aliased `bunto server` to `bunto serve`. (#792)
  * Updated gem versions for Kramdown, Rake, Shoulda, Cucumber, and RedCarpet. (#744)
  * Refactored Bunto subcommands into Bunto::Commands submodule, which now contains them (#768)
  ...
  * Accepting strings as arguments to bunto-import command (#910)
  ...
  * Patch for multibyte URI problem with `bunto serve` (#723)
  ...
  * Add SVG support to Bunto/WEBrick. (#407, #406)
...
### Minor Enhancements
  ...
  * Bug Fixes
  * Add Bunto binary as executable to gemspec (@dysinger)
...
### Minor Enhancements
  ...
  * Bug Fixes
  * Prevent Bunto from picking up the output directory as a source (@JackDanger)
