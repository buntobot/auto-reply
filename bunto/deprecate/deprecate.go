...
var (
	deprecatedRepos = map[string]string{
		"bunto/bunto-help": `This repository is no longer maintained. If you're still experiencing this problem, please search for your issue on [Bunto Talk](https://talk.buntorb.com/), our new community forum. If it isn't there, feel free to post to the Help category and someone will assist you. Thanks!`,
	}
)
