// unify-labels is a CLI which will add, rename, or change the color of labels so they match the Bunto org's requirements.
package main
...
func main() {
	...
	repos, _, err := context.GitHub.Repositories.List("bunto", &github.RepositoryListOptions{
